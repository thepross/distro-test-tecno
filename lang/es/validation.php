...
return [
    ...
    'attributes'             => [
        ...
        'detalles'                 => 'detalles',
        'detalles.*.id_producto'   => 'producto del detalle',
        'detalles.*.cantidad'      => 'cantidad del detalle',
        'detalles.*.precio_compra' => 'precio de compra del detalle',
        'detalles.*.precio_venta'  => 'precio de venta del detalle',
